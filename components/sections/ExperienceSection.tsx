...
const ExperienceSection = () => {
  ...
  return (
    <section id="experience" className="py-16 sm:py-20 bg-gradient-to-b from-gray-50 to-white relative">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-6 sm:space-y-8">
          {experiences.map((job, index) => (
            ...
            >
              <Card
                className={`bg-gradient-to-r ${job.gradient} border border-${job.borderColor} backdrop-blur-sm hover:border-gray-400 transition-all duration-300 shadow-sm hover:shadow-md`}
              >
                <CardHeader>
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                    <div className="mb-4 lg:mb-0">
                      <CardTitle className="text-xl sm:text-2xl font-mono font-bold text-gray-800 mb-2">
                        {job.title}
                      </CardTitle>
                      <CardDescription className="text-gray-600 text-lg font-mono font-semibold">
                        {job.company}
                      </CardDescription>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 text-gray-500 font-mono text-sm">
                ...
                <CardContent>
                  <ul className="space-y-3">
                    {job.achievements.map((achievement, i) => (
                      <li key={i} className="flex items-start space-x-3 text-gray-700 font-mono">
